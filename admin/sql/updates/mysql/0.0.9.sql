...
INSERT INTO `#__TENNIS_COURTS` (`id`, `name`, `posx`, `posy`, `title`, `features`) VALUES
(1, '11', 1, 1, 'Center court', 'PROFI'),
(2, '12', 1, 2, 'Left from center court', 'MEDIUM_DOUBLE'),
(3, '13', 1, 3, 'Left behind of the center court', 'PRACTICE_DOUBLE'),
(4, '21', 2, 1, 'Right behind the center court.', 'PRACTICE_DOUBLE'),
(5, '31', 3, 1, 'Only single practice court.', 'PRACTICE_SINGLE');
