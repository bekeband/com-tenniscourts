...
CREATE TABLE `TENNIS_TARIFF` (
  `ID` varchar(30) NOT NULL,
  `PR_PER_HOUR` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO `TENNIS_TARIFF` (`ID`, `PR_PER_HOUR`) VALUES
('BASE', 2000),
('BASE_DISCOUNT', 1600),
('BASE_INDOOR', 4000),
('BASE_INDOOR_DISCOUNT', 3200);

ALTER TABLE `TENNIS_TARIFF`
  ADD PRIMARY KEY (`ID`);
...
INSERT INTO `TENNIS_FEATURES` (`ID`, `SINGLE_PLAY`, `DOUBLE_PLAY`, `PRACTICING`, `MEDIUM`, `COMPETITION`, `PRICE_MULT`) VALUES
('MEDIUM_DOUBLE', 1, 1, 1, 1, 0, 1),
('PRACTICE_DOUBLE', 1, 1, 1, 0, 0, 0.9),
('PRACTICE_SINGLE', 1, 0, 1, 0, 0, 0.8),
('PROFI', 1, 1, 1, 1, 1, 1.2);

ALTER TABLE `TENNIS_FEATURES`
  ADD PRIMARY KEY (`ID`);
...
CREATE TABLE `TENNIS_COURTS` (
  `ID` varchar(20) NOT NULL,
  `POS X` int(11) NOT NULL,
  `POS Y` int(11) NOT NULL,
  `TITLE` varchar(40) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL,
  `FEATURES` varchar(24) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `TENNIS_COURTS` (`ID`, `POS X`, `POS Y`, `TITLE`, `FEATURES`) VALUES
...
CREATE TABLE `TENNIS_TIMES` (
  `ID` varchar(12) NOT NULL,
  `BEGIN` time NOT NULL,
  `END` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `TENNIS_TIMES` (`ID`, `BEGIN`, `END`) VALUES
