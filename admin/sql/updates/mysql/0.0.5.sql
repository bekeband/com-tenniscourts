...
INSERT INTO `#__TENNIS_MENU_OPTIONS` (`TITLE`, `FEATURE`) VALUES
('OPTIONS 1 TITLE', 'OPTIONS 1 FEATURE'),
('OPTIONS 2 TITLE', 'OPTIONS 2 FEATURE'),
('OPTIONS 3 TITLE', 'OPTIONS 3 FEATURE'),
('OPTIONS 4 TITLE', 'OPTIONS 4 FEATURE');
